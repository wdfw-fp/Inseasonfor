...
fish_river_ocean<-dplyr::inner_join(flow_temp_dat |>
                                dplyr::filter(month==forecast_month,
                                              md==forecast_md) |> 
                                dplyr::select(year=Year,cfs_mean,temp_mean),
                              cnts_for_mod_fun(counts_through,Bon_cnts)) |> 
