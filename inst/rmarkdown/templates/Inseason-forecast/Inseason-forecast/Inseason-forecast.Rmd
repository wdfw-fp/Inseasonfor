...
```{r 10_year_prop}
prop10yr_tab<-Bon_ch_year |> dplyr::filter(CountDate>=                                           as.Date(paste0(forecast_year,"-04-01")))|> dplyr::ungroup()|>  dplyr::mutate(Date=format(CountDate,"%d-%b")) |> 
...
```{r 5_year_prop}
prop5yr_tab<-Bon_ch_year |> dplyr::filter(CountDate>=                                           as.Date(paste0(forecast_year,"-04-01")))|> dplyr::ungroup()|>  dplyr::mutate(Date=format(CountDate,"%d-%b")) |> 
