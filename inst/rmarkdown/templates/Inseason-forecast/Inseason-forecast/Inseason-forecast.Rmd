...
```{r MAPE_10_year, fig.cap= "Mean absolute percent error  (over 15 year reetrospectiv) of predictions based on cumulative counts and 10-year average run timing, by day of year."}
Bon_ch_year |>
...
```{r plot_pred_separate,fig.cap="Daily predictions and prediction intervals (95% and 50%). Where pridiction intervals are >250% of <40% of the prediction, the interval is not shown." }
